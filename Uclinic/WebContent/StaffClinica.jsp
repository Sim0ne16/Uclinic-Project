					...
					<h3 class="category"><%=d.getSpecializzazione() %></h5>
						<h3 class="card-title"><%=d.getNome()%> <%=d.getCognome()%></h5>
 						...
 						<div class="tooltip" >
                            ...
                            <a class="btn btn-dark" href="#" value="press me" title="Modifica"><i  style="color:#2eab97" class="fa-solid fa-user-pen fa-2x"></i></a>
                            <a class="btn btn-dark" href="#" value="press me" title="Elimina"><i  style="color:#2eab97" class="fa-solid fa-user-xmark fa-2x"></i> </a>
