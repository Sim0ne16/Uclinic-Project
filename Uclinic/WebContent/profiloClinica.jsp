	...
	<section id="wrapper">
		...
		<div class="dxandsx">
			<div class="left">
				...
				<ul class="asd">
					<div class="nomeC">
						<i class="fa-solid fa-house-chimney-medical fa-4x"></i>
						<h3 style="font-size: 30px" id="titoloC"><%=C.getNome()%></h3>
					...
					<li><i class="fa-solid fa-location-dot fa-2x"></i> Indirizzo:
						<%=C.getIndirizzo()%></li>
			...
			<div class="right">
				...
				<div class="cercaP">
					...
					<div class="dati-search">
						<p>Se hai bisogno di trovare un paziente inserisci il suo
							nome, cognome o codice fiscale!</p>
					</div>


					<form class="cercaPazienti" action="CercaPaziente" method="post">
						<input type="search" name="cercaP" id="btn-cercaP"
							placeholder="Inserisci parametro ricerca..."> <input
							type="submit" value="Invia" id="sub-cercaP">
				...
				<div class="gestioneApp">
					...
					<div class="gest-app">
						<a href="gestisciAppuntamenti.jsp?id=<%=C.getIdClinica()%>"><button
								type="submit" class="btnApp">Gestisci appuntamento</button></a>
					</div>

					<div class="gest-app">
						<a href="appuntamentiConfermati.jsp"><button type="submit"
								class="btnApp">Appuntamenti confermati</button></a>
					</div>
